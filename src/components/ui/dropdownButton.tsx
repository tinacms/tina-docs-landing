    ...
    <>
      ...
      <div className="relative group hidden lg:block">
        ...
        {links && links.length > 0 && (
          <div className="absolute top-full left-0 mt-2 w-max bg-background border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
            <ul className="py-2">
